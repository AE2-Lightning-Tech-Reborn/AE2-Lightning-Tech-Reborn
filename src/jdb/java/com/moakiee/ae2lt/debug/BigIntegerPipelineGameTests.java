    ...
    public static void formedMultidimensionalMachinesRunAnExactOrder(GameTestHelper h) {
        ...
        h.runAfterDelay(
                ...
                () -> {
                    ...
                    GridHelper.createConnection(node, cpuPort.getMainNode().getNode());
                    GridHelper.createConnection(node, matrixPort.getMainNode().getNode());
                    h.runAfterDelay(
                            30,
                            () -> {
                                require(
