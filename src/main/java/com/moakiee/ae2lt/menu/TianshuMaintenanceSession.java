...
public final class TianshuMaintenanceSession {
    public static final net.minecraft.network.codec.StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, MaintenanceAction> ACTION_CODEC =
            net.minecraft.network.codec.StreamCodec.of((buf, action) -> {
