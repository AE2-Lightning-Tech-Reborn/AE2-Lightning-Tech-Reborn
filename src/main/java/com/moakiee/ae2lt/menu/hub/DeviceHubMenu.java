...
public class DeviceHubMenu extends AbstractContainerMenu {
    ...
    public void toggleRailgunEhvBeam() {
        ...
        ModDataComponents.RAILGUN_SETTINGS.set(railgun, settings.withEhvBeam(!settings.ehvBeamEnabled()));
    }
    ...
    public void cycleSelectedModuleConfig(int optionIndex) {
        ...
        if ("flight_inertia".equals(config.key())
                ...
                || PhaseLockSubmodule.FLIGHT_LOCK_CONFIG_KEY.equals(config.key())) {
