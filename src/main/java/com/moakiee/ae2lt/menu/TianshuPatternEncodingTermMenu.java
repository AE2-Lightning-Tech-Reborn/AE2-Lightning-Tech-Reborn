...
public class TianshuPatternEncodingTermMenu extends PatternEncodingTermMenu implements TianshuMaintenanceMenu {
    ...
    @Override
    public void setTerminalViewMode(TianshuTerminalViewMode mode) { applyTerminalViewMode(mode, true); }
    ...
    private void applyTerminalViewMode(TianshuTerminalViewMode mode, boolean persist) {
        ...
        if (isClientSide()) sendClientAction(persist ? "setTerminalViewMode" : "setTemporaryTerminalViewMode", mode);
            ...
            if (persist) tianshuHost.setMaintainableView(maintainableView);
            broadcastChanges();
        }
    }
