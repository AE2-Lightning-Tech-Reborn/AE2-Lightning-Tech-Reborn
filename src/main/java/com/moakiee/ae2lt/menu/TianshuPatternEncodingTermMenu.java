...
@IPNIgnore
public class TianshuPatternEncodingTermMenu extends PatternEncodingTermMenu implements TianshuMaintenanceMenu {
    ...
    private static final StreamCodec<RegistryFriendlyByteBuf, TianshuMaintenanceSession.MaintenanceAction> MAINTENANCE_ACTION_CODEC =
            ...
            }, buf -> new TianshuMaintenanceSession.MaintenanceAction(buf.readVarInt(), buf.readUUID(), buf.readBoolean()));
    ...
    protected TianshuPatternEncodingTermMenu(
        ...
        registerClientAction(new appeng.menu.guisync.ClientActionKey<Void>("clearOmniversalDraft"), this::clearOmniversalDraft);
    }
    ...
    public void selectOmniversalPattern(ItemStack pattern) {
        ...
        if (isClientSide()) {
            ...
            omniversalStatus = "ae2lt.tianshu.omniversal.selected";
            net.neoforged.neoforge.client.network.ClientPacketDistributor.sendToServer(new SelectOmniversalPatternPacket(containerId, pattern.copyWithCount(1)));
            return;
        }
    ...
    public void clearOmniversalDraft() {
        if (isClientSide()) {
            sendClientAction(new appeng.menu.guisync.ClientActionKey<Void>("clearOmniversalDraft"));
            return;
        }
        omniversalDraft = OmniversalPatternDraft.empty();
        restoreOmniversalSlots();
    ...
    public void sendClosedLoopResultPage(
        ...
        PacketDistributor.sendToPlayer(player, new ClosedLoopResultPagePacket(
                containerId,
    ...
    @Override
    public TianshuTerminalViewMode getTerminalViewMode() {
    ...
    @Override
    public void setTerminalViewMode(TianshuTerminalViewMode mode) {
        if (mode == null) return;
    ...
    @Override public appeng.menu.me.common.MEStorageMenu maintenanceMenu() { return this; }
