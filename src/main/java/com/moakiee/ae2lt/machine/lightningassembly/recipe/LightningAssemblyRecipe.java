...
public final class LightningAssemblyRecipe implements LegacyMachineRecipe<LightningAssemblyRecipeInput> {
    ...
    public LightningAssemblyRecipe(
        ...
        this(priority, inputs, ItemStackTemplate.fromNonEmptyStack(result), totalEnergy, lightningCost, lightningTier);
    }

    private LightningAssemblyRecipe(
            int priority,
            List<LightningSimulationIngredient> inputs,
    ...
    @Override
    public RecipeSerializer<LightningAssemblyRecipe> getSerializer() {
        return ModRecipeTypes.LIGHTNING_ASSEMBLY_SERIALIZER.get();
    }

    @Override
    public RecipeType<LightningAssemblyRecipe> getType() {
    ...
    public static final class Serializer {
        ...
        public static final RecipeSerializer<LightningAssemblyRecipe> INSTANCE = new RecipeSerializer<>(CODEC, STREAM_CODEC);
    }
}
