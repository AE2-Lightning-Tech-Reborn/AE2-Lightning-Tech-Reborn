...
public final class BigMatrixRecipe {
    ...
    public CompoundTag save(HolderLookup.Provider registries) {
        ...
        tag.put("definition", definition.toTagGeneric());
        ...
        tag.put("output", pattern.output().toTagGeneric());
    ...
    public static BigMatrixRecipe load(CompoundTag tag, HolderLookup.Provider registries) {
        var definition =
                (AEItemKey)
                        Objects.requireNonNull(
                                AEKey.fromTagGeneric(tag.getCompound("definition")));
        ...
        return new BigMatrixRecipe(
                definition,
                slots,
                Objects.requireNonNull(AEKey.fromTagGeneric(tag.getCompound("output"))),
                tag.getLong("amount"),
                inputs,
                outputs);
    }
