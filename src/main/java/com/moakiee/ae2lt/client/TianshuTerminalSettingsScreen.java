...
public final class TianshuTerminalSettingsScreen<M extends MEStorageMenu>
    ...
    public void drawFG(GuiGraphicsExtractor graphics, int offsetX, int offsetY, int mouseX, int mouseY) {
        ...
        if (patternTerminal) {
            ...
            drawWrapped(graphics,
                    ...
                    10, 160, 180, 0xFF666666);
        }
        graphics.text(font, Component.translatable("ae2lt.tianshu.settings.jei_supply"),
                10, patternTerminal ? 202 : 30, 0xFF404040, false);
    }
    ...
    private void drawWrapped(GuiGraphicsExtractor graphics, Component text, int x, int y, int width, int color) {
