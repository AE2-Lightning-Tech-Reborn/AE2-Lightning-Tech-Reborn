...
public abstract class OverloadAlloyAnvilMenuMixin {
    @ModifyExpressionValue(method = "onTake", at = @At(value = "INVOKE", target =
            "Lnet/minecraftforge/common/ForgeHooks;onAnvilRepair(Lnet/minecraft/world/entity/player/Player;Lnet/minecraft/world/item/ItemStack;Lnet/minecraft/world/item/ItemStack;Lnet/minecraft/world/item/ItemStack;)F"))
