...
public final class TianshuWctIntegration {
    ...
    public static void registerUpgrades() {
        Upgrades.add(AE2wtlib.MAGNET_CARD, ModItems.TIANSHU_WIRELESS_CRAFTING_TERMINAL.get(), 1);
    }
    public static boolean hasTianshuCrafting(ItemStack stack) {
        return WUTHandler.wirelessTerminals.containsKey(Ae2wtlibIntegration.TIANSHU_CRAFTING_NAME)
                && WUTHandler.hasTerminal(stack, Ae2wtlibIntegration.TIANSHU_CRAFTING_NAME);
    }
