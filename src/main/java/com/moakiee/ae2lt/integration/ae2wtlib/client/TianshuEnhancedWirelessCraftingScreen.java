...
public final class TianshuEnhancedWirelessCraftingScreen extends TianshuWirelessCraftingTermScreen<TianshuWirelessCraftingTermMenu> {
    ...
    @Override protected void drawWorkAreaBackground(GuiGraphicsExtractor graphics, int offsetX, int offsetY) {
    ...
    @Override public void extractSlot(GuiGraphicsExtractor graphics, Slot slot, int mouseX, int mouseY) {
