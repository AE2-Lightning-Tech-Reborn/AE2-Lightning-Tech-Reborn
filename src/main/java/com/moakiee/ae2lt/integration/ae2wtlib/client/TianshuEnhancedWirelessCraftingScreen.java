...
public final class TianshuEnhancedWirelessCraftingScreen extends TianshuWirelessCraftingTermScreen<TianshuWirelessCraftingTermMenu> {
    private final appeng.client.gui.widgets.ActionButton settingsButton;
    private final IconButton magnetButton, trashButton;
    ...
    public TianshuEnhancedWirelessCraftingScreen(TianshuWirelessCraftingTermMenu menu, Inventory inventory, Component title, ScreenStyle style) {
        ...
        settingsButton = new appeng.client.gui.widgets.ActionButton(appeng.api.config.ActionItems.TERMINAL_SETTINGS, button -> switchToScreen(new TianshuWirelessToolsScreen(this, WirelessPage.SETTINGS)));
