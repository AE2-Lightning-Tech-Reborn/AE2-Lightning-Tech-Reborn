...
class TianshuSeedRefillServiceTest {
    ...
    @Test void fullNetworkLeavesSeedsInPlaceAndReportsReturnBlocked() {
        ...
        assertEquals(8L, sync.problems().getFirst().returnBlocked());
    }
    ...
    private static ClosedLoopPatternPayload payload(AEKey seed, long amount, int execution, int stored, boolean enabled) {
        var member = new SourcePatternSnapshot(Identifier.fromNamespaceAndPath("ae2", "encoded_processing_pattern"), null, null);
    ...
    private static final class TestKey extends AEKey {
        ...
        @Override public void toTag(net.minecraft.world.level.storage.ValueOutput tag) {
            tag.putString("id", id);
